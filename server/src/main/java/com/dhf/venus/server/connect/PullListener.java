 ...
 */
public class PullListener extends ReplyListener {

	private final static Log LOGGER = LogFactory.getLog(PullListener.class);

	private final EventFactory factory;

	private final Access access;

	public PullListener(Pusher pusher, Access access, EventFactory factory) {
		super(pusher);
		this.access = access;
	...
	public void listen(Event event) {
		...
		if (configs.valid()) {
			...
			PullListener.LOGGER.info("Response configs: " + message);
